...
export type RepositoryListQuery = (
  ...
  & { search: (
    ...
    & { repos?: Maybe<Array<Maybe<(
      { __typename?: 'SearchResultItemEdge' }
      & { repo?: Maybe<{ __typename?: 'App' } | { __typename?: 'Issue' } | { __typename?: 'MarketplaceListing' } | { __typename?: 'Organization' } | { __typename?: 'PullRequest' } | (
        { __typename?: 'Repository' }
...
export const RepositoryListDocument = gql`
  ...
  search(type: REPOSITORY, query: $queryString, first: 100) {
    ...
    `;
export type RepositoryListComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<RepositoryListQuery, RepositoryListQueryVariables>, 'query'> & ({ variables: RepositoryListQueryVariables; skip?: boolean; } | { skip: boolean; });

    export const RepositoryListComponent = (props: RepositoryListComponentProps) => (
      <ApolloReactComponents.Query<RepositoryListQuery, RepositoryListQueryVariables> query={RepositoryListDocument} {...props} />
    );
    
export type RepositoryListProps<TChildProps = {}, TDataName extends string = 'data'> = {
      [key in TDataName]: ApolloReactHoc.DataValue<RepositoryListQuery, RepositoryListQueryVariables>
    } & TChildProps;
export function withRepositoryList<TProps, TChildProps = {}, TDataName extends string = 'data'>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  RepositoryListQuery,
  RepositoryListQueryVariables,
  RepositoryListProps<TChildProps, TDataName>>) {
    return ApolloReactHoc.withQuery<TProps, RepositoryListQuery, RepositoryListQueryVariables, RepositoryListProps<TChildProps, TDataName>>(RepositoryListDocument, {
...
/**
 * __useRepositoryListQuery__
 *
 * To run a query within a React component, call `useRepositoryListQuery` and pass it any options that fit your needs.
 * When your component renders, `useRepositoryListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRepositoryListQuery({
 *   variables: {
 *      queryString: // value for 'queryString'
 *   },
 * });
 */
export function useRepositoryListQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<RepositoryListQuery, RepositoryListQueryVariables>) {
        return ApolloReactHooks.useQuery<RepositoryListQuery, RepositoryListQueryVariables>(RepositoryListDocument, baseOptions);
      }
export function useRepositoryListLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<RepositoryListQuery, RepositoryListQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<RepositoryListQuery, RepositoryListQueryVariables>(RepositoryListDocument, baseOptions);
        }
export type RepositoryListQueryHookResult = ReturnType<typeof useRepositoryListQuery>;
export type RepositoryListLazyQueryHookResult = ReturnType<typeof useRepositoryListLazyQuery>;
export type RepositoryListQueryResult = ApolloReactCommon.QueryResult<RepositoryListQuery, RepositoryListQueryVariables>;